...
class WorldModelsTrainer(OffPolicyRLAlgorithm):
    """
    ...
    def __init__(
        ...
        """
        super(WorldModelsTrainer, self).__init__(env, discount, reward_scale, epochs, steps_per_epoch, initial_steps, replay_buffer, model_itrs, batch_size, model.input_normalizer)
        self.policy = policy
        self.model = model
    ...
    def evaluate(self, train_dataset=False):
        ...
        for traj in dataset:
            ...
            with torch.no_grad():
                ...
                preds = preds['observation']['state'].squeeze()
